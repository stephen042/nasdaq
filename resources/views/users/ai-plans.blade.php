                ...
                <div class="side-app">
                    ...
                    <div class="main-container container-fluid">
                        ...
                        <div class="page-header">
                            <div>
                                <h1 class="page-title">Investment Plans <i class="fa fa-question-circle"
                                        data-bs-placement="bottom" data-bs-toggle="tooltip"
                                        title="Choose your Preferred Bot To trade for you"></i></h1>
                                <ol class="breadcrumb">
                            ...
                            <div class="ms-auto pageheader-btn">
                                ...
                                Total Balance: <span class="h4 text-bold">
                            ...
                            <div class="col">
                                <div class="card">
                                    <div class="card-header">
                                        <h3 class="card-title">Ai Plans</h3>
                                    </div>
                                    <livewire:user.ai-plans />
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row row-sm">
                            <div class="col-lg-12">
                                <div class="card">
                                    <div class="card-header">
                                        <h3 class="card-title">ALL Investment plans Purchases</h3>
                                    </div>
                                    <div class="card-body">
                                                ...
                                                <tbody>
                                                    @forelse ($plans_transactions as $count => $plans_transaction)
                                                        <tr>
                                                            ...
                                                            <td>{{ $plans_transaction->plan_ROI }}%</td>
                                                            <td>
                                                            ...
                                                            <td>
                                                                {{ date('Y-M-d h:i a', strtotime($plans_transaction->created_at)) }}
                                                            </td>
                                                        </tr>
                                                    @empty
                                                        <tr></tr>
