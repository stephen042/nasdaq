                ...
                <div class="side-app">
                    ...
                    <div class="main-container container-fluid">
                        ...
                        <div class="page-header">
                            <div>
                                <h1 class="page-title">
                                    <i class="side-menu__icon fas fa-university"></i> 
                                    Bank Withdrawal | Withdraw Your Earnings -$ 
                                </h1>
                                <ol class="breadcrumb">
                            ...
                            <div class="card col-xl-10 col-lg-10 col-sm-12" style="border-radius: 10px;">
                                <div class="card-header" style="background-color: #5A52B5;border-radius: 10px">
                                    <div class="card-title text-bold ">
                                        <i class="fas fa-university"></i> Bank Withdrawal Methods
                                    </div>
                                </div>
                                <!-- <center> -->
                                <livewire:user.bank-withdrawl />
                                <!-- </center> -->
