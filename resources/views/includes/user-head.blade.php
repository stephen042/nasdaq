@if (auth()->check() && Route::currentRouteName() !== 'security_settings')
...
<!-- FAVICON -->
<link rel="shortcut
      icon" type="image/x-icon" href="{{ asset('home-assets/assets/fav/favicon-apple-touch.png') }}">
...
_smartsupp.key = 'b5ff61a94310f69118a6b8dbe374f655e441469a';
